...
def within_x(co1, co2):
    ...
    if co1.x2 > co2.x1 and co1.x2 < co2.x2:
        return True
    if co2.x1 > co1.x1 and co2.x1 < co1.x2:
        return True
    if co2.x2 > co1.x1 and co2.x2 < co1.x2:
        return True
    else:
        return False
...
def within_y(co1, co2):
    ...
    if co1.y2 > co2.y1 and co1.y2 < co2.y2:
        return True
    if co2.y1 > co1.y1 and co2.y1 < co1.y2:
       return True
    if co2.y2 > co1.y1 and co2.y2 < co1.y2:
        return True
    else:
        return False
...
g = Game()
platform1 = PlatformSprite(g,PhotoImage(file="platform1.gif"),150,440,100,10)
platform2 = PlatformSprite(g,PhotoImage(file="platform1.gif"),0,480,100,10)
...
platform_list = [platform1,platform2,platform3,platform4,platform5,platform6,platform7,platform8,platform9,platform10]
g.sprites.extend(platform_list)
